...
CREATE TABLE `Classe` (
  ...
  `niveau_enseignement` enum('elementaire','primaire') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `niveau_classe` enum('CP','CP, CE1','CE1','CE1, CE2','CE2','CE2, CM1','CM1','CM1, CM2','CM2') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `Utilisateur` (
  ...
  `genre` enum('Monsieur','Madame') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
